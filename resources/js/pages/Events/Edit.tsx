...
export default function EditEvent({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        start_date: event.start_date.replace('Z', '').slice(0, 16),
        end_date: event.end_date.replace('Z', '').slice(0, 16),
    ...
    return (
        <AppLayout user={auth.user}>
            <div className="max-w-2xl">
                <h1 className="mb-6 text-3xl font-bold text-gray-900">Edit Event</h1>
